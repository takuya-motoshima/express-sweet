...
export var dependencies = {"aws-sdk":"^2.1142.0","body-parser":"^1.19.0","class-transformer":"^0.2.3","class-validator":"^0.12.2","connect-redis":"^6.1.3","cookie-parser":"~1.4.4","cors":"^2.8.5","debug":"~2.6.9","dotenv":"^8.2.0","esm":"^3.2.25","express":"^4.18.2","express-hbs":"^2.3.3","express-session":"^1.17.1","fs-extra":"^9.0.1","glob":"^7.1.6","hbs":"~4.0.4","http-errors":"~1.6.3","ioredis":"^4.27.6","mariadb":"^2.4.0","mime-types":"^2.1.27","module-alias":"^2.2.2","moment":"^2.26.0","morgan":"~1.9.1","multer":"^1.4.2","nodejs-shared":"^1.0.2","passport":"^0.4.1","passport-local":"^1.0.0","redis":"^4.1.0","sequelize":"^5.22.4","uniqid":"^5.2.0"};
export var devDependencies = {"@types/aws-sdk":"^2.7.0","@types/connect-redis":"^0.0.18","@types/cookie-parser":"^1.4.2","@types/debug":"^4.1.5","@types/express":"^4.17.14","@types/express-session":"^1.17.3","@types/http-errors":"^1.8.0","@types/ioredis":"^4.26.4","@types/jest":"^26.0.22","@types/multer":"^1.4.5","@types/node":"^14.18.32","@types/passport":"^1.0.6","@types/passport-local":"^1.0.33","@types/validator":"^13.1.3","jest":"^26.6.3","json2module":"0.0.3","rollup":"^2.51.1","rollup-plugin-commonjs":"^10.1.0","rollup-plugin-json":"^4.0.0","rollup-plugin-node-resolve":"^5.2.0","rollup-plugin-terser":"^7.0.2","rollup-plugin-typescript2":"^0.30.0","ts-loader":"^8.1.0","ts-node":"^9.1.1","tsc-alias":"^1.2.9","tsconfig-paths":"^3.9.0","tslint":"^6.1.3","typescript":"^4.2.3"};
