...
export var dependencies = {"aws-sdk":"^2.690.0","body-parser":"^1.19.0","class-transformer":"^0.2.3","class-validator":"^0.12.2","connect-redis":"^6.1.3","cookie-parser":"~1.4.4","cors":"^2.8.5","debug":"~2.6.9","dotenv":"^8.2.0","esm":"^3.2.25","express":"^4.16.4","express-hbs":"^2.3.3","express-session":"^1.17.1","fs-extra":"^9.0.1","glob":"^7.1.6","hbs":"~4.0.4","http-errors":"~1.6.3","ioredis":"^4.27.6","mariadb":"^2.4.0","mime-types":"^2.1.27","module-alias":"^2.2.2","moment":"^2.26.0","morgan":"~1.9.1","multer":"^1.4.2","nodejs-shared":"^1.0.2","passport":"^0.4.1","passport-local":"^1.0.0","redis":"^4.1.0","reflect-metadata":"^0.1.13","sequelize":"^5.22.4","uniqid":"^5.2.0"};
