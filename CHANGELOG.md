...
**Demo Improvements**
- Reorganized demo structure into separate `web-app` and `rest-api` directories
- Added new REST API demo showcasing CORS functionality with simple CRUD endpoints
- Improved web-app demo documentation and Docker configuration
- Updated Docker configuration to use `utf8mb4` character set
- Optimized Dockerfile with layer reduction and `npm ci` for reproducibility
- Added SQL comments and ON DELETE CASCADE to foreign keys in schema
